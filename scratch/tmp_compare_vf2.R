...
options(legacy_opts)
l <- FindVariableFeatures(obj, selection.method='vst', nfeatures=2000, verbose=FALSE)
options(rewrite_opts)
r <- FindVariableFeatures(obj2, selection.method='vst', nfeatures=2000, verbose=FALSE)
